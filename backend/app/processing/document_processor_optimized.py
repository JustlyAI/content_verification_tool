...
OPTIMIZED VERSION with 5-10x performance improvements
"""
...
class DocumentProcessor:
    ...
    def convert_document(
        ...
        """
        Convert document to Docling format with optimized performance
        ...
        try:
            ...
            if is_docx:
                cprint(
                    f"[PROCESSOR] DOCX file detected, converting to PDF first...",
                    "yellow",
                )
                ...
                cprint(
                    f"[PROCESSOR] Will process converted PDF: {pdf_path.name}",
                    "cyan",
                )
            else:
                conversion_path = tmp_path
                cprint(
                    f"[PROCESSOR] Native PDF detected, processing with V2 backend",
                    "cyan",
                )
